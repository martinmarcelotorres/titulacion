...
@Component({
  selector: 'app-unitprogram-form',
  templateUrl: './unitprogram-form.component.html',
  styleUrls: ['./unitprogram-form.component.scss']
})
export class UnitprogramFormComponent implements OnInit, OnDestroy {
