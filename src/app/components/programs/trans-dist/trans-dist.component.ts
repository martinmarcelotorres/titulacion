...
import { SheetService } from 'src/app/components/component-funcionality/services/programs/sheet.service';
...
@Component({
  selector: 'app-trans-dist',
  templateUrl: './trans-dist.component.html',
  styleUrls: ['./trans-dist.component.scss']
})




export class TransDistComponent implements OnInit{
  dataBD: any;
  dataANX1E: any;
  dataANX1: any;
  dataINFPI: any;
