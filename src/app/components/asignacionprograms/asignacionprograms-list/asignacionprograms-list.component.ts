...
import { AsignacionprogramsFormComponent } from '../asignacionprograms-form/asignacionprograms-form.component';
...
@Component({
  selector: 'app-asignacionprograms-list',
  templateUrl: './asignacionprograms-list.component.html',
  styleUrls: ['./asignacionprograms-list.component.scss'],
  providers: [{ provide: MAT_DATE_FORMATS, useValue: MY_DATE_FORMATS }]
})
export class AsignacionprogramsListComponent implements OnInit{
  fechaDesde!: Date;
  fechaHasta!: Date;
  ...
  openDialog(): void {
    const dialogRef = this.dialog.open(AsignacionprogramsFormComponent, {
      width: "35%",
    });
